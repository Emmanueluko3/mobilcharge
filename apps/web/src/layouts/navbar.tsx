  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-between items-center px-4 py-4 lg:px-10 lg:py-4 lg:border-b">
        ...
        {/* Mobile Menu */}
        <div
          className={`fixed top-0 left-0 w-full z-10 min-h-screen bg-white text-black transition-transform duration-300 transform ${
                ...
                {user || isAuthenticated ? (
                  <div className="flex flex-col gap-4 lg:order-last">
                    <Link
                      to={`/${role() === "admin" ? "admin" : "dashboard"}`}
                      onClick={closeMenu}
                      className="rounded-md text-base text-white whitespace-nowrap bg-primary-500 transition-all flex items-center justify-center py-2 px-4 font-semibold border border-primary-500 hover:bg-primary-700"
                    >
                      {t("Go to Dashboard")}
                    </Link>
                    <Link
                      ...
                      onClick={closeMenu}
                      className="font-semibold w-full flex justify-center items-center text-center rounded-md py-2 px-4 text-base text-primary-500 border border-primary-500 hover:bg-primary-500 hover:text-white transition-all"
                    >
                      {t("Settings")}
                    </Link>
                  </div>
